...
# end with '/' otherwise 301 redirect
...
class TweetApiTests(TestCase):
    ...
    def test_create_api(self):
        ...
        response = self.user1_client.post(TWEET_CREATE_API, {
            'content': 'Hello World, this is the first tweet!'
        })
    ...
    def test_create_with_files(self):
        ...
        # check retrieve api include photo url
    ...
    def test_retrieve(self):
        ...
        # fetch a single tweet, get all its comments at the same time
        ...
        self.create_comment(self.user2, tweet, 'Today is a nice day')
        self.create_comment(self.user1, tweet, 'Tomorrow is also be a nice day')
        response = self.anonymous_client.get(url)
        self.assertEqual(len(response.data['comments']), 2)

        # tweet include avatar and nickname
    ...
    def test_pagination(self):
        ...
        new_tweet = self.create_tweet(self.user1, 'a new tweet coming in')
