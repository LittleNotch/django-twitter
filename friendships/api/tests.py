...
class FriendshipApiTests(TestCase):
    ...
    def test_followers_pagination(self):
        ...
        # anonymous has not followed any user
        response = self.anonymous_client.get(url)
    ...
    def _paginate_until_the_end(self, url, expected_pages, friendships):
        results, pages = [], 0
        response = self.anonymous_client.get(url)
        ...
        # friendships is in asce order, results are in desc order
